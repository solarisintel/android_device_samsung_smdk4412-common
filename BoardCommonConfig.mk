...
# Hardware tunables
BOARD_HARDWARE_CLASS := hardware/samsung/linegagehw \
...
# Charging mode
# AEX XXX_LED_PATH not used, kernel dev/class name renamaed standard name
BOARD_BATTERY_DEVICE_NAME := "battery"
BOARD_CHARGER_ENABLE_SUSPEND := true
WITH_LINEAGE_CHARGER := false

# in kernel led driver name renamed
